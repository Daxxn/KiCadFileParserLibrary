...
public class RuleSettingsModel : Model
{
   ...
   /// <summary>
   /// Solder mask to copper clearance
   /// </summary>
   ...
   /// <summary>
   /// Use height for trace length calculations
   /// </summary>
