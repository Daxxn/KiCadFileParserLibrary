...
public class SExprFileReader
{
   ...
   /// <summary>
   /// Construct a <see cref="SExprFileReader"/> with custom parser options.
   /// </summary>
   ...
   #region Methods
   /// <summary>
   /// Read the SExpression file from the provided file path.
   /// </summary>
   /// <param name="path">Path to the file.</param>
   /// <returns>The root node of the SExpression tree.</returns>
